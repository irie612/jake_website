...
const tat_images: ImageData[] = [
    ...
    { src: tat_img_12, alt: ""},
	{ src: tat_img_13, alt: "Fine line single needle black and grey single stem rose tattoo on the hand" },
    { src: tat_img_14, alt: "Pair of black and grey American traditional scorpion tattoos on the thighs with red blood drops" },
    { src: tat_img_15, alt: "Bold American traditional cap Coleman flash tattoo of a butterfly lady head in full colour" },
    { src: tat_img_16, alt: "Black and grey Bryony botanical plant and flower tattoo" },
    { src: tat_img_17, alt: "Pair of black and grey wrist tattoos of a butterfly caught in a web and a fine line sacred heart" },
    { src: tat_img_18, alt: "Black and grey American traditional picture machine flash tattoo of a snake wrapped around an eagle" },
    { src: tat_img_19, alt: "American traditional red sacred heart tattoo with green thorns blue Japanese flames and blue blood drops" },
    { src: tat_img_20, alt: "90s Borneo tribal black work of spiral on ankle bone" },
    ...
    { src: tat_img_33, alt: "American traditional black and grey Spaulding and rogers flash tattoo of a grim reaper with flames" },
    ...
    { src: tat_img_36, alt: "American traditional Joseph Hartley tattoo flash design of a cross with red and yellow roses" },
    { src: tat_img_37, alt: "Black and grey Japanese phoenix half sleeve tattoo with flames" },
